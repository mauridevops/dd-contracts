...
contract sFtl is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Destiny", "sFTL", 9) ERC20Permit() {
    ...
    /**
        @notice increases sFTL supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sFTL
